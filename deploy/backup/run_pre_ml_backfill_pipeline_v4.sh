...
echo "[INFO] PRE-ML BACKFILL V4 START_DATE=$START_DATE END_DATE=$END_DATE PROFILE_ID=$PROFILE_ID"
...
echo "[DONE] pre-ML backfill pipeline v4 completed"
