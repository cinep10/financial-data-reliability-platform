...
PROMPT_VERSION = "ai_action_recommender_v2"
...
def fetch_actions(cur, profile_id, dt):
    ...
    if "profile_id" in cols:
        select_parts.append("profile_id")
    else:
        select_parts.append("NULL AS profile_id")
    ...
    if "action_type" in cols:
        select_parts.append("action_type")
    else:
        select_parts.append("NULL AS action_type")

    if "priority" in cols:
        select_parts.append("priority")
    else:
        select_parts.append("NULL AS priority")
